...
| **Build North, Table #3** | **Scheduled for Wednesday 16 September 2026. Not published.** The first ticketed room, implementing `ADR-026`. Twenty seats on a published price ladder, $125 for the first ten, $200 for the next five, $300 for the last five, plus four service provider seats at $500. Every seat carries the same three minutes on one question. Full publishing kit in `assets/events/build-north-2026-09-16-kit.md`, decision in `ADR-027` | Three conditions before it publishes: the venue question (a ticketed event in a residential amenity room, with no written permission and no CGL insurance), no testimonials or past-event footage on the page until permission and an ADR exist, and a go or move decision on Monday 8 September if fewer than ten seats have sold |
