...
>
> **The portrait station and the filming are private.** They appear in direct messages and in the confirmation email only. Nothing about cameras, portraits, footage or media goes on Luma, on LinkedIn, in any post, or in any image.
>
...
**The portrait is the private lever that works on every segment.** A clinic owner wants a current headshot. So does a founder, a researcher, a pharmacist who does not own the pharmacy. Nobody in any of these groups likes their current photo. That is why the private offer needs no rewriting when the target shifts, even though the public page never mentions it.
...
- Anyone in health answers it cold. A dentist, a founder, a lab scientist, a pharmacy owner
- It makes the speaker look knowledgeable, which is why they will post the clip once they have it
- It sounds like something a person asks you at dinner, not something a panel asks
- It survives the audience switch, which no operator-specific question does

Publish it. Knowing the question in advance removes the only anxiety the evening could produce, and it costs nothing because there is no wrong answer.
...
- 6:30, arrive and eat. Food is out from the start, so there's no waiting around for a programme to begin
- 7:15, one question goes round the table. Everyone answers. Nothing to prepare, no slides, no standing up
- 8:00, back to ordinary dinner conversation for the rest of the night
- 9:30, done

Here's the question, so you're not wondering: what's the one thing people outside your work always get wrong about it?

**What you leave with**

- A table of people who now understand what you actually do, without you having had to explain it three times
- Everyone else's answer to that question. A dentist and a pharmacist describe the same patient completely differently, and both of them are right
...
I bring a photographer and a small lighting setup to these. Anyone who wants one gets a proper portrait, five minutes, and a short filmed answer to the question of the night. The files come to you a few days later and they're yours outright, to use however you want. No cost, and nothing is attached to it.

It's completely optional. Plenty of people eat dinner and never go near the camera, and that's a perfectly normal way to spend the evening. Tell me at the door and nobody will point anything at you.
...
Thursday 27 August, 6:30 to 9:30, dinner's covered.
...
That last line turns a decline into the on-site feature in `docs/17-event-formats.md` instead of a loss. It is the most valuable sentence in the kit.
...
There's also a photographer there with proper lighting, so you can come away with a real headshot and a short clip of your answer, both sent to you afterwards and both yours to keep. Entirely optional, no cost.
...
[Students only] I also need one person to help run the photo station: hold the running order, brief whoever's next, keep it from sitting idle. It's a real job for the evening and it means you'll have spoken to everyone in the room by the end of it. Interested?
...
Generate direction 1 first. If the warmth reads as twee, fall back to direction 3, which cannot fail.
...
- **Craft bans, absolute:** no emoji, no icon fonts, no stock icon libraries, no stock photography, no blur, no gradients, no drop shadows, nothing left at a default size. Illustration must be drawn as SVG line work
- **Never depict people, faces, or a populated room.** Empty table, empty chairs, plates, glasses. This is an honesty constraint, not a style preference
- **Never depict a camera, tripod, studio light or any recording equipment.** Not in any frame
- Texture is encouraged: paper tooth, slight halftone, letterpress ink edges. This is what stops it reading as corporate
...
5. *What's the one thing people outside your work always get wrong about it?*
6. *Nothing to prepare. You just answer it.*
7. *A dentist and a pharmacist describe the same patient completely differently. Both of them are right.*
...
Somewhere around quarter past seven, one question goes round and everyone answers it. Nothing to prepare, nobody stands up.

What's the one thing people outside your work always get wrong about it?

I've wanted to put that to a mixed room for a while. My guess is no two answers overlap.

Dinner's covered, there's no cost. Link's in the comments.
```

### Post 2. Day 5, the question

```
Genuine question for anyone who works in health.
...
| 5 | What's the one thing people outside your work always get wrong about it? | **Heaviest frame in the set** |
| 6 | Nothing to prepare. You just answer it. | Quiet |
| 7 | A dentist and a pharmacist describe the same patient completely differently. Both of them are right. | Medium |
